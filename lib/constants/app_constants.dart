class AppConstants {
  ...
  // Default Alarm Sounds (generated by tool/generate_sounds.py)
  static const List<Map<String, dynamic>> alarmSounds = [
    {
      'id': 'default',
      'name': 'Classic Alarm',
      'asset': 'assets/sounds/default_alarm.wav',
      'icon': '🔔',
    },
    {
      'id': 'gentle',
      'name': 'Gentle Wake',
      'asset': 'assets/sounds/gentle_wake.wav',
      'icon': '🌅',
    },
    {
      'id': 'energetic',
      'name': 'Energetic',
      'asset': 'assets/sounds/energetic.wav',
      'icon': '⚡',
    },
    {
      'id': 'nature',
      'name': 'Nature Sounds',
      'asset': 'assets/sounds/nature.wav',
      'icon': '🌲',
    },
  ];
}
